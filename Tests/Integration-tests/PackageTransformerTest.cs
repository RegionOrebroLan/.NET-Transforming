...
namespace IntegrationTests
{
	...
	public class PackageTransformerTest(Fixture fixture)
	{
		...
		public void GetTransformInformation_Test()
		{
			...
			transformInformation = this._fixture.PackageTransformer.GetTransformInformation(directoryPath, fileToTransformPatterns, transformationNames);
			Assert.Equal(6, transformInformation.Count);
			Assert.Equal(Path.Combine(directoryPath, "AppSettings.json"), transformInformation.ElementAt(0).Key);
			Assert.Equal(Path.Combine(directoryPath, "Directory", "JSON-file.json"), transformInformation.ElementAt(1).Key);
			Assert.Equal(Path.Combine(directoryPath, "Directory", "XML-file.xml"), transformInformation.ElementAt(2).Key);
			Assert.Equal(Path.Combine(directoryPath, "Settings.For.json"), transformInformation.ElementAt(3).Key);
			Assert.Equal(Path.Combine(directoryPath, "Views", "Web.config"), transformInformation.ElementAt(4).Key);
			Assert.Equal(Path.Combine(directoryPath, "Web.config"), transformInformation.ElementAt(5).Key);
		...
		public void GetTransformMap_Test()
		{
			...
			Assert.Equal(6, transformMap.Count);
			Assert.Equal(Path.Combine(directoryPath, "Views", "Web.config"), transformMap.ElementAt(0).Key);
			Assert.Equal(4, transformMap.ElementAt(0).Value.Count);
			Assert.Equal(Path.Combine(directoryPath, "Views", "Web.1.2.3.4.5.config"), transformMap.ElementAt(0).Value.ElementAt(0));
			Assert.Equal(Path.Combine(directoryPath, "Views", "Web.AB.CDE.FGHI.config"), transformMap.ElementAt(0).Value.ElementAt(1));
			...
			Assert.Equal(Path.Combine(directoryPath, "Web.Test.config"), transformMap.ElementAt(1).Value.ElementAt(3));
			Assert.Equal(Path.Combine(directoryPath, "Web.That-Should.Not-Be.Used.config"), transformMap.ElementAt(1).Value.ElementAt(4));
			Assert.Equal(Path.Combine(directoryPath, "AppSettings.json"), transformMap.ElementAt(2).Key);
			Assert.Equal(4, transformMap.ElementAt(2).Value.Count);
			Assert.Equal(Path.Combine(directoryPath, "AppSettings.1.2.3.4.5.json"), transformMap.ElementAt(2).Value.ElementAt(0));
			Assert.Equal(Path.Combine(directoryPath, "AppSettings.AB.CDE.FGHI.json"), transformMap.ElementAt(2).Value.ElementAt(1));
			Assert.Equal(Path.Combine(directoryPath, "AppSettings.Release.json"), transformMap.ElementAt(2).Value.ElementAt(2));
			Assert.Equal(Path.Combine(directoryPath, "AppSettings.Test.json"), transformMap.ElementAt(2).Value.ElementAt(3));
			...
			Assert.Equal(Path.Combine(directoryPath, "Settings.For.json"), transformMap.ElementAt(4).Key);
			Assert.Equal(4, transformMap.ElementAt(4).Value.Count);
			Assert.Equal(Path.Combine(directoryPath, "Settings.For.1.2.3.4.5.json"), transformMap.ElementAt(4).Value.ElementAt(0));
			Assert.Equal(Path.Combine(directoryPath, "Settings.For.AB.CDE.FGHI.json"), transformMap.ElementAt(4).Value.ElementAt(1));
			Assert.Equal(Path.Combine(directoryPath, "Settings.For.Release.json"), transformMap.ElementAt(4).Value.ElementAt(2));
			Assert.Equal(Path.Combine(directoryPath, "Settings.For.Test.json"), transformMap.ElementAt(4).Value.ElementAt(3));
			Assert.Equal(Path.Combine(directoryPath, "Directory", "XML-file.xml"), transformMap.ElementAt(5).Key);
			Assert.Single(transformMap.ElementAt(5).Value);
			Assert.Equal(Path.Combine(directoryPath, "Directory", "XML-file.Release.xml"), transformMap.ElementAt(5).Value.ElementAt(0));
